...
public class Principal {
    ...
    public static void main(String[] args) {
        ...
        var i = 0;
        while(i<numProcesoA){
            PAzul pAzul = new PAzul(contadorId, buffer1,productosAProducir,1,barrera);            String concat = "PAzul" + i;
        ...
        PNaranja pN2 = new PNaranja(2, buffer1,buffer2,productosAProducir,2, barrera);
        pN2.start();
